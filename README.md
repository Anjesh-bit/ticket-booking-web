...
A full-stack concert ticket booking application built with React + TypeScript (frontend) and Node.js + TypeScript (backend), backed by PostgreSQL and Redis. Built as a take-home assignment for TechCraft.
